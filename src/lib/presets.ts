...
const DEFAULT_VOX:VoxConfig = { level: 0.2, tone: [ 0.5, 0.5 ], wander: false, oct: -1, num: 16, spread: 2 }
const NO_VOX:VoxConfig      = { level: 0.0, tone: [ 0.5, 0.5 ], wander: false, oct:  0, num: 0,  spread: 0 }
const DEEP_VOX:VoxConfig    = { level: 0.7, tone: [ 0.5, 0.5 ], wander: false, oct: -2, num: 24, spread: 0.8 }
